...
namespace Meta.WitAi.Composer.Handlers
{
    ...
    public class ComposerActionHandler : MonoBehaviour, IComposerActionHandler
    {
        ...
        /// Calls all action events, action attributes & action coroutines
        /// </summary>
        ...
        // Performs action coroutines in order & then removes from placeholder
